...
@Component({
  selector: '[allTitheChart]',
  templateUrl: './all-tithe-chart.component.html',
  styleUrl: './all-tithe-chart.component.scss',
})
export class AllTitheChartComponent extends BaseComponent implements OnInit {
  ...
  fetchData() {
    ...
    this.titheSvc
      .getAllTitheReportByYear(this.year())
      .pipe(
        finalize(() => {
